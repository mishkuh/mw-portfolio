...
const projects = [
  {
    id: 1,
    title: "Arizona Fire Features Website",
    description: "A professional website for a Phoenix-based fire feature installation company. Features an image gallery, contact form, and store.",
    tags: ["React", "Node.js", "Next.js", "Tailwind", "Motion", "Shopify", "Sanity CMS"],
    demoUrl: "https://www.arizonafirefeatures.com/"
  },
  {
    id: 2,
    title: "Green Generation Landscaping Website",
    description: "A professional website for a Puget Sound landscaping business to highlight their services and portfolio. ",
    tags: ["React", "Node.js", "Next.js", "Tailwind", "Motion", "NeonDB", "Vercel", "Payload CMS"],
